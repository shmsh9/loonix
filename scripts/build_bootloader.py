...
def main():
    ...
    c_flags = f"-c {inc_flags} -target {param['ARCH']}-unknown-windows -ffreestanding -std=c11 -Wall -Werror -pedantic -fshort-wchar -Wno-microsoft-static-assert -Wno-microsoft-enum-value"

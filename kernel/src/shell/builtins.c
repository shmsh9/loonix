...
int builtins_net(int argc, char **argv){
    uint8_t packet[] = {
        ...
        0x00, 0x34, 0x88, 0x4c, 0x00, 0x00, 0x78, 0x06,
        0x1d, 0xdb, 0x8e, 0xfa, 0x4b, 0xee, 0xc0, 0xa8,
        0x01, 0x0c, 0x01, 0xbb, 0xad, 0xee, 0x7d, 0x80,
        0xbd, 0x77, 0xca, 0xf9, 0xdd, 0xfd, 0x80, 0x10,
        0x02, 0xc0, 0x36, 0xf9, 0x00, 0x00, 0x01, 0x01,
        0x08, 0x0a, 0x02, 0x6c, 0xe9, 0x14, 0xb9, 0x32,
        0x68, 0x1a
    };
    uint8_t packet2[] = {
        0xa0, 0xce, 0xc8, 0x94, 0x37, 0x33, 0x34, 0x49,
        0x5b, 0xd9, 0x46, 0x9c, 0x08, 0x00, 0x45, 0x00,
        0x00, 0x54, 0x4c, 0x31, 0x00, 0x00, 0x38, 0x01,
        0x72, 0xc2, 0x01, 0x01, 0x01, 0x01, 0xc0, 0xa8,
        0x01, 0x0c, 0x00, 0x00, 0x30, 0x32, 0x00, 0x06,
        0x00, 0x01, 0x97, 0xaa, 0xbf, 0x65, 0x00, 0x00,
        0x00, 0x00, 0xb4, 0xe3, 0x05, 0x00, 0x00, 0x00,
    ...
    net_debug_print_packet(packet, sizeof(packet)/sizeof(packet[0]));
    net_debug_print_packet(packet2, sizeof(packet2)/sizeof(packet2[0]));
